package de.zorro909.codecheck.legacy.editor.idea;
...
public class IdeaExecutor implements EditorExecutor {
    ...
    public boolean open(Path path, Position pos) {
        String[] params = new String[] { ideaExecutable, "--line", String.valueOf(pos.line), "--column",
                String.valueOf(pos.column), path.toString() };
    ...
    public boolean openAndWait(Path path, Position pos) {
        String[] params = new String[] { ideaExecutable, "--wait", "--line", String.valueOf(pos.line), "--column",
                String.valueOf(pos.column), path.toString() };
